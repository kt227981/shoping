            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <h3 class="card-title">S<b style="font-size: 30px">HOW GIRLS CLOTHES</b></h3>
...
{{--                                        <a href="" class="btn btn-sm btn-warning"><i class="fa fas-solid fa-pen"></i></a>--}}
                                        <a href="{{route('girls/destroy',$data->id)}}" class="btn btn-sm btn-danger"><i class="fa fas-solid fa-trash"></i></a>
                                    </td>
