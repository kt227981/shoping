    ...
    <div class="row px-xl-5">
        ...
        <div class="col-lg-5 mb-5">
            ...
            <div class="d-flex flex-column mb-3">
                <h5 class="font-weight-semi-bold mb-3">Postal Address</h5>
                <p class="mb-2"><i class="fa fa-map-marker-alt text-primary mr-3"></i>Sadarpur , Palanpur ,385001</p>
                <p class="mb-2"><i class="fa fa-envelope text-primary mr-3"></i>kiran@gmail.com.com</p>
                <p class="mb-2"><i class="fa fa-phone-alt text-primary mr-3"></i>+91 7945784308</p>
            </div>
            <div class="d-flex flex-column">
                <h5 class="font-weight-semi-bold mb-3">Permanent Address</h5>
                <p class="mb-2"><i class="fa fa-map-marker-alt text-primary mr-3"></i>Sadarpur , Palanpur ,385001</p>
                <p class="mb-2"><i class="fa fa-envelope text-primary mr-3"></i>kiran@gmail.com.com</p>
