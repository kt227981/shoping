            ...
            <div id="product-carousel" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner border">
                    <div class="carousel-item active">
                        <img class="" src="{{asset('storage/admin/gents/image/'.$detail->product_image)}}" style="height: 473px; width: 390px;     padding-left: 105px;" alt="Image">
                    </div>
                </div>
...
{{--                </a>--}}
        ...
        <div class="col-lg-7 pb-5">
            ...
            <h3 class="font-weight-semi-bold mb-4">${{$detail->product_price}}.00</h3>
            ...
            <div class="d-flex align-items-center mb-4 pt-2">
                ...
                <a href="{{route('add/cart',$detail->id)}}" class="btn btn-primary px-3"><i class="fa fa-shopping-cart mr-1"></i> Add To Cart</a>
            </div>
